...
#the country output is a product of the i which gets printed
#the gdp output is a vector of vals that gets returned by the function

avgGDP("Afghanistan", 2000:2003)
